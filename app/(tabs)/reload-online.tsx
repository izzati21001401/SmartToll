        ...
        <View style={styles.paymentContainer}>
          <TouchableOpacity
            style={[
              ...
              selectedPayment === "credit" && styles.selectedOption,
            ]}
            onPress={() => {
              setSelectedPayment("credit");
              router.push("/reload-card");
            }}
          >
            <Ionicons
              name="card"
              size={20}
              color={selectedPayment === "credit" ? "#007AFF" : "black"}
            />
            <Text
              style={[
                styles.paymentText,
                selectedPayment === "credit" && styles.selectedText,
              ]}
            >
              Credit/Debit Card
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.paymentOption,
              selectedPayment === "bank" && styles.selectedOption,
            ]}
          ...
          >
            <Ionicons
              name="business"
              size={20}
              color={selectedPayment === "bank" ? "#007AFF" : "black"}
            />
            <Text
              style={[
                styles.paymentText,
                selectedPayment === "bank" && styles.selectedText,
              ]}
            >
              Online Banking
            </Text>
          ...
          <View style={styles.section}>
            {bankOptions.map((bank) => (
              ...
              >
                ...
                />
                <Image
                  source={bank.image} // Using the image path from the bank object
